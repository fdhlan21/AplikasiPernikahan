...
<View style={{flexDirection:'row', paddingVertical:100,top:20 }}>
    <View style={{paddingVertical:20, margin:20, backgroundColor:colors.white, padding:5, paddingHorizontal:65, borderRadius:10,  borderWidth:2, borderColor:colors.primary, bottom:90, left:10}}>
...
<TouchableOpacity    onPress={()=>navigation.navigate('HalamanLogin')}  style={{padding:5, backgroundColor:colors.danger, paddingVertical:5,  paddingHorizontal: 50,  borderRadius:10,  left:40}}>
