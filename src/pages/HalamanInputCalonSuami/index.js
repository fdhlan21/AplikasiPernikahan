...
function HalamanInputCalonSuami({navigation}) {
...
<View style={{ backgroundColor:colors.primary, paddingVertical:6, borderBottomRightRadius:10, borderBottomLeftRadius:10,}}>
<Text style={{color:colors.white, fontFamily:'Alata-Regular',  textAlign:'center', fontSize:20, top:10}}>Input data</Text>
<TouchableOpacity  style={{ bottom:20, left:9, bottom:22}} onPress={()=>navigation.navigate('HalamanDaftarNikah')}  >
...
<Text style={{fontFamily:'Alata-Regular', left:20, }}>Nama calon Suami (Linto Baro)</Text>
</View>
...
<TouchableOpacity    onPress={()=>navigation.navigate('HalamanInputCalonIsteri')}     style={{padding:5, backgroundColor:colors.primary,  paddingHorizontal:80,  borderRadius:10, paddingHorizontal:80, paddingVertical:20, elevation:6, top:80, right:20  }}>
...
export default HalamanInputCalonSuami;
